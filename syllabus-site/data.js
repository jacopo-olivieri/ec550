window.SYLLABUS_DATA = {
  course: {
    ...
    overview: [
      "There is a central tension between economic growth, which is critical to poverty reduction, and the externalities from growth in the form of climate change.",
      "These lectures focus on energy across subsistence, transformation, and frontier settings: access and reliability, diffusion of cleaner energy, and innovation that can make clean growth cheaper and faster.",
    ],
  },
  sections: [
    {
